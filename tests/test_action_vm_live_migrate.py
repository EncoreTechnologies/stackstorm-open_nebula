...
from vm_live_migrate import VmLiveMigrate
import unittest.mock as mock

__all__ = [
    'VmLiveMigrateTestCase'
]


class VmLiveMigrateTestCase(OneBaseActionTestCase):
    __test__ = True
    action_cls = VmLiveMigrate
    ...
    def test_run(self, mock_session):
        ...
        mock_one = mock.Mock()
        mock_one.vm.migrate.return_value = expected_result
        ...
        mock_one.vm.migrate.assert_called_with(vm_id, host_id, True, False, 0)

...
from vm_unlock import VmUnlock
...
class VmUnlockTestCase(OneBaseActionTestCase):
    __test__ = True
    action_cls = VmUnlock
    ...
    def test_run(self, mock_session):
        ...
        mock_one = mock.Mock()
        mock_one.vm.unlock.return_value = expected_result
        ...
        mock_one.vm.unlock.assert_called_with(vm_id)

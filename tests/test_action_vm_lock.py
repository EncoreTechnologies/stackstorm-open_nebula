...
class VmLockTestCase(OneBaseActionTestCase):
    __test__ = True
    action_cls = VmLock
    ...
    def test_run(self, mock_session):
        ...
        mock_one = mock.Mock()
        mock_one.vm.lock.return_value = expected_result
        ...
        mock_one.vm.lock.assert_called_with(vm_id, 1)
